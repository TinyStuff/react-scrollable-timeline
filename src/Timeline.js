...
var getPosition = function (evt, _a) {
    var startDate = _a.startDate, ratio = _a.ratio;
...
var DateNode = function (date) { return React.createElement("div", null, format(date, "yyyy-MM-dd")); };
var dateNodeWrapper = function (dateNode, date, viewSize) {
    var _a = getPosition({ start: date, end: addDays(date, 1) }, viewSize), width = _a.width, left = _a.left;
    var cls = "is-future";
    switch (true) {
        default:
            cls = "is-future";
...
var Timeline = function (_a) {
    var groups = _a.groups, events = _a.events, _b = _a.startDate, startDate = _b === void 0 ? subDays(startOfDay(new Date()), 2) : _b, _c = _a.endDate, endDate = _c === void 0 ? addDays(startOfDay(new Date()), 60) : _c, _d = _a.width, width = _d === void 0 ? 5000 : _d, _e = _a.resourceHeaderWidth, resourceHeaderWidth = _e === void 0 ? 200 : _e, _f = _a.groupKey, groupKey = _f === void 0 ? "articleId" : _f, _g = _a.getGroupData, getGroupData = _g === void 0 ? extractGroupData : _g, _h = _a.resourceNode, resourceNode = _h === void 0 ? GroupNode : _h, _j = _a.itemNode, itemNode = _j === void 0 ? EventRow : _j, _k = _a.dateNode, dateNode = _k === void 0 ? DateNode : _k, _l = _a.onEventClick, onEventClick = _l === void 0 ? function (evt) { } : _l;
    ...
    var range = eachDayOfInterval({ start: startDate, end: endDate });
...
var DateLine = function (_a) {
    ...
    var _b = getPosition({ start: date, end: addDays(date, 1) }, viewSize), width = _b.width, left = _b.left;
    return (React.createElement("div", { style: {
            width: width + "px",
            display: "inline-flex",
            position: "absolute",
